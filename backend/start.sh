...
python -c "from fastembed import TextEmbedding, TextCrossEncoder; TextEmbedding(model_name='BAAI/bge-small-en-v1.5'); TextCrossEncoder(model_name='BAAI/bge-reranker-base')"
